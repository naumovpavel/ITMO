...
public class TcpClient extends Client{
    ...
    public Response sendAndReceive(Request request) {
        ...
        try {
            ...
            var r = ResourceBundle.getBundle("bundles.Errors", request.getLocale());
            response = new Response( r.getString("server_not_available"), Status.ERROR);
            socket = null;
        }
        return response;
    }
    ...
    public void connect() throws IOException {
        ...
        inputStream = new BufferedInputStream(socket.getInputStream(), MAX_PACKAGES_AT_ONCE*PACKAGE_SIZE);
    ...
    public boolean isConnected() {
        ...
        sendAndReceive(new Request(Commands.INFO));
        return socket != null;
    }
}